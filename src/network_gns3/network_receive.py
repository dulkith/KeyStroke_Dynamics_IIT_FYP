...
with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as sock:
    ...
    max_rounds = 400
    max_features = 11
    columns = ['subject', 'DD.period.t', 'DD.t.i', 'DD.i.e', 'DD.e.five',
               'DD.five.Shift.r', 'DD.Shift.r.o', 'DD.o.a', 'DD.a.n', 'DD.n.l', 'DD.l.Return']
    subjects = [2, 3, 4, 5, 7, 8, 10, 11, 12, 13, 15, 16, 17, 18, 19, 20, 21, 22, 24, 25, 26, 27, 28, 29, 30,
    ...
    for user in subjects:
        for i in range(max_rounds):
            row = []
            print("Receiving Subject: " + str(user) +
                  " ---------- Iteration: " + str(i) + " ---------- ")
            row.append(user)
